...
Let's now start to customize the plot and modify to color palette:
...
We can customize the plot background with the `tm_style` function:
...
Last but not least, let's add title and labels for the geographic locations:
