...
* `covid19sf_demo` [**deprecated**] -  Cases summarized by date, transmission and case disposition
* `covid19sf_homeless` [**deprecated**] -  Confirmed cases by homelessness
* `covid19sf_age` [**deprecated**] -  Cases summarized by age group
* `covid19sf_gender`[**deprecated**] -  Confirmed cases summarized by gender
* `covid19sf_summary` [**deprecated**] -  Cases summarized by date, transmission and case disposition
