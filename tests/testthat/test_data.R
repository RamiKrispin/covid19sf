test_that(desc = "Test the data dimension", {
  expect_equal(base::nrow(covid19sf_summary) > 1400, TRUE)
  ...
  expect_equal(base::nrow(covid19sf_age) > 5470, TRUE)
  expect_equal(base::ncol(covid19sf_age) == 5, TRUE)

  expect_equal(base::nrow(covid19sf_gender) > 2040, TRUE)
  ...
  expect_equal(base::nrow(covid19sf_homeless) > 850, TRUE)
...
test_that(desc = "Test dates/times variable", {
  ...
  expect_equal(base::min(covid19sf_age$specimen_collection_date) == as.Date("2020-03-10"), TRUE)
